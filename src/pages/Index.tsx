...
const Index = () => {
  ...
  const certifications = ["Google – Crash Course on Python", "IBM – Machine Learning with Python", "IBM – Introduction to Computer Vision and Image Processing", "DeepLearning.AI – Neural Networks and Deep Learning", "Great Learning – Artificial Intelligence with Python"];
  const achievements = ["Winner: Temenos Tem-E-thon 2025 Hackathon (Won MacBook Air M3)", "Member: IEEE SRMIST (R&D)", "Member: Data Science Community SRM (AI/ML)"];
        ...
        <div className="container mx-auto px-6 py-4">
          <div className="flex justify-between items-center">
            ...
            <div className="hidden md:flex space-x-8">
              {['Home', 'About', 'Projects', 'Experience', 'Skills', 'Contact'].map(item => <button key={item} onClick={() => scrollToSection(item.toLowerCase())} className={`hover:text-blue-400 transition-colors ${activeSection === item.toLowerCase() ? 'text-blue-400' : 'text-white/80'}`}>
                  {item}
                </button>)}
            </div>
          </div>
        ...
        <div className="container mx-auto px-6 text-center relative z-10">
          ...
          duration: 0.8
            ...
            <div className="flex flex-wrap justify-center gap-4 mb-8">
              <Button onClick={() => scrollToSection('projects')} className="bg-gradient-to-r from-blue-500 to-purple-600 hover:from-blue-600 hover:to-purple-700 text-white px-8 py-3 rounded-full">
                View Projects
              </Button>
      ...
      <section id="skills" className="py-20">
        <div className="container mx-auto px-6">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
            {Object.entries(skills).map(([category, items], index) => <motion.div key={category} initial={{
            opacity: 0,
            y: 20
          }} whileInView={{
            opacity: 1,
                ...
                <Card className="bg-white/5 backdrop-blur-lg border-white/10 h-full">
                  ...
                  <CardContent>
                    <div className="flex flex-wrap gap-2">
                      {items.map(skill => <Badge key={skill} className="bg-purple-500/20 text-purple-300 border-purple-500/30">
                          {skill}
                        </Badge>)}
                    </div>
                  </CardContent>
          ...
          <div className="max-w-2xl mx-auto">
            ...
            once: true
              ...
              <div className="grid md:grid-cols-2 gap-6">
                <Input placeholder="Your Name" className="bg-white/5 border-white/20 text-white placeholder:text-white/50" />
                <Input type="email" placeholder="Your Email" className="bg-white/5 border-white/20 text-white placeholder:text-white/50" />
              </div>
              <Textarea placeholder="Your Message" rows={6} className="bg-white/5 border-white/20 text-white placeholder:text-white/50" />
              <Button type="submit" className="w-full bg-gradient-to-r from-blue-500 to-purple-600 hover:from-blue-600 hover:to-purple-700 text-white py-3">
                Send Message
              </Button>
            </motion.form>
